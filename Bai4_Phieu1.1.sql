...
-- Dua ra 10 mat hang co SoLuongN nhieu nhat trong nam 2019
select top 10 SanPham.MaSP, NgayNhap, SoLuongNhap
...
-- Dua ra MaSP,TenSP cua cac san pham do cong ty 'Samsung' san xuat do nhan vien co ma 'NV01' nha­p.
...
-- Dua ra SoHDN, MaSP, SoLuongN, NgayNhap cua mat hang co MaSP la 'SP02', duoc nhan vien 'NV02' xuat.
select Nhap.SoHDN, MaSP, SoLuongNhap, NgayNhap
from Nhap inner join PNhap on Nhap.SoHDN=PNhap.SoHDN
where MaSP='SP02' and MaNV='NV02'


-- Dua ra MaNV, TenNV da xuat mat hang co ma 'SP02' ngay '03-02-2020'
...
where NgayXuat='2020-02-03' and MaSP='SP02'
