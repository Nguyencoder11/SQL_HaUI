...
select NhanVien.MaNV, TenNV, sum(SoLuongNhap*DonGiaNhap) as N'Tổng tiền nhập'
from Nhap inner join PNhap on Nhap.SoHDN=PNhap.SoHDN
inner join NhanVien on PNhap.MaNV=NhanVien.MaNV
where YEAR(NgayNhap)=2018 and MONTH(NgayNhap)=08
group by NhanVien.MaNV, TenNV
having SUM(SoLuongNhap*DonGiaNhap)>100000
